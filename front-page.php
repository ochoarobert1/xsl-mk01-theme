...
<main class="container-fluid p-0" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
    <div class="row no-gutters">
        ...
        <section class="home-benefits col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="container">
                <div class="row justify-content-between">
                    ...
                    <article class="home-benefits-item col-xl-3 col-lg-3 col-md-4 col-sm-12 col-12">
        ...
        <section class="home-sections col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="container">
                <div class="row">
                    <div class="home-sections-col-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="container p-0">
                            <div class="row justify-content-between">
                                ...
                                <?php if ($section_item['big_item'] == 'on') { $size= 'sections_medium'; $class = 'mini col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12'; } else { $size= 'sections_mini'; $class = 'medium col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12'; } ?>
                                <article class="home-sections-item home-sections-image <?php echo $class; ?>">
                    ...
                    <div class="home-sections-col-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="container">
                            <div class="row">
                                ...
                                <article class="home-sections-text col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="home-sections-item large home-sections-image col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="home-sections-item-wrapper">
        ...
        <section class="home-contact-form col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="container">
                <div class="row">
                    <div class="home-contact-text col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
