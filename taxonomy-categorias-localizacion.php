...
<main class="container-fluid p-0" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
    <div class="row no-gutters">
        ...
        <section class="local-tax-container col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" data-aos="fadeIn">
            <div class="container">
                <div class="row justify-content-between">
                    ...
                    <a class="local-main-tax-item col" href="<?php echo get_term_link($item); ?>">
                        <?php echo $item->name; ?>
                    </a>
                    <?php } ?>
                    <?php endif; ?>
