                    ...
                    <div class="contact-items-content col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row justify-content-center align-items-center">
                            ...
                            <div class="contact-item contact-item-direction col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <img src="<?php echo get_template_directory_uri(); ?>/images/balearic-logo.png" alt="Balearic home Mallorca" class="img-fluid" />
                                <?php echo get_post_meta(get_the_ID(), 'xsl_contact_directions', true); ?>
